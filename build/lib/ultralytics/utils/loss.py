...
class BboxLoss(nn.Module):
    ...
    def forward(self, pred_dist, pred_bboxes, anchor_points, target_bboxes, target_scores, target_scores_sum, fg_mask):
        ...
        # print('imgsz',imgsz)
        # iou = bbox_iou(pred_bboxes[fg_mask], target_bboxes[fg_mask], xywh=False, CIoU=False,MPDIoU=True,imgsz=imgsz)  # CIoU=True
...
class v8DetectionLoss:
    ...
    def __call__(self, preds, batch):
        ...
        # img_height = imgsz[1].item()  # Get image height
        # img_width = imgsz[0].item()
        # print(img_width)
        # print(img_height)
        # print(imgsz.shape)
        ...
        if fg_mask.sum():
            ...
            # loss[0], loss[2] = self.bbox_loss(pred_distri, pred_bboxes, anchor_points, target_bboxes, target_scores,
            #                                target_scores_sum, fg_mask,imgsz)
