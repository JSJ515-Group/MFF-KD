...
parser.add_argument('--image_path', default='E:/DIOR_dataset_yolo/images/val',type=str, help="path of images")
parser.add_argument('--label_path', default='E:/DIOR_dataset_yolo/labels/val',type=str, help="path of labels .txt")
parser.add_argument('--save_path', type=str,default='E:/DIOR_dataset_yolo/data.json', help="if not split the dataset, give a path to a json file")
