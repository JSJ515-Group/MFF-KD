...
def get_params():
    params = {
        'weight': 'E:/SCAM_yolo/distiil/distill/DIOR-bckd-cwd3/weights/best.pt',  # 现在只需要指定权重即可,不需要指定cfg
        'device': 'cuda:0',
        'method': 'HiResCAM',
        # GradCAMPlusPlus, GradCAM, XGradCAM, EigenCAM, HiResCAM, LayerCAM, RandomCAM, EigenGradCAM
        'layer': [10, 23, 20, 25, 30],
...
if __name__ == '__main__':
    ...
    model(r'E:/DIOR_dataset_yolo/images/val', 'E:/SCAM_yolo/heatmap/DIOR/windowsbckdcwd')