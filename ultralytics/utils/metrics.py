...
def bbox_alpha_iou(box1, box2, xywh=True, GIoU=False, DIoU=False, CIoU=False, SIoU=False, EIoU=False, Focal=False, alpha=3, gamma=0.5, eps=1e-7):
...
class ConfusionMatrix:
    ...
    def plot(self, normalize=True, save_dir='', names=(), on_plot=None):
        ...
        # # 添加调整字体大小的代码
        # plt.rcParams.update({'font.size': 12 if self.nc < 50 else 10})  # 根据需要调整字体大小
