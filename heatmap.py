...
def get_params():
    params = {
        'weight': 'E:/gold_yolo/ultralytics-main/runs/train/VidDrone_yolov8-goldyoloE_4batch_0.4giou/weights/best.pt',
        'cfg': 'E:/gold_yolo/ultralytics-main/yolov8-goldyoloE.yaml',
        'device': 'cuda:0',
...
if __name__ == '__main__':
    ...
    model(r'E:/xinVisDrone/images/val/0000069_00001_d_0000001.jpg', 'result')